...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { establishdate: @party.establishdate, logo: @party.logo, name: @party.name, shortname: @party.shortname } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { establishdate: @party.establishdate, logo: @party.logo, name: @party.name, shortname: @party.shortname } }
