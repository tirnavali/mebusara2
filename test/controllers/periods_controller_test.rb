...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { enddate: @period.enddate, name: @period.name, startdate: @period.startdate } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { enddate: @period.enddate, name: @period.name, startdate: @period.startdate } }
